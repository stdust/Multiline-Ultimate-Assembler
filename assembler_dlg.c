...
static void SetScintillaDesign(HWND hWnd, HINSTANCE hInstance, RAFONT *praFont)
{
	...
	else
	{
		...
		MyGetColorfromini(hInstance, _T("color_jmp"), &val, RGB(255, 0, 0));
		colorJmp = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_call"), &val, RGB(0, 77, 102));
		colorCall = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_ret"), &val, RGB(0, 0, 0));
		colorRet = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_nop"), &val, RGB(128, 128, 128));
		colorNop = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_reg_special"), &val, RGB(128, 0, 0));
		colorRegSpecial = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_fpu"), &val, RGB(136, 68, 0));
		colorFpu = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_ext"), &val, RGB(136, 0, 0));
		colorExt = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_type"), &val, RGB(0, 68, 153));
		colorType = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_other"), &val, RGB(136, 102, 34));
		colorOther = (COLORREF)val;
		// Load Custom Background colors for Light Mode (Defaults to bckcol)
		MyGetColorfromini(hInstance, _T("color_jmp_bg"), &val, RGB(255, 255, 0));
		colorJmpBg = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_call_bg"), &val, RGB(0, 255, 255));
		colorCallBg = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_ret_bg"), &val, RGB(121, 249, 121));
		colorRetBg = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_nop_bg"), &val, RGB(255, 251, 240));
		colorNopBg = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_reg_special_bg"), &val, RGB(255, 251, 240));
		colorRegSpecialBg = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_fpu_bg"), &val, RGB(255, 251, 240));
		colorFpuBg = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_ext_bg"), &val, RGB(255, 251, 240));
		colorExtBg = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_type_bg"), &val, RGB(255, 251, 240));
		colorTypeBg = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_other_bg"), &val, RGB(255, 251, 240));
		colorOtherBg = (COLORREF)val;
		MyGetColorfromini(hInstance, _T("color_reg_bg"), &val, RGB(255, 251, 240));
		colorRegBg = (COLORREF)val;
	}
