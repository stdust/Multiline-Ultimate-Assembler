...
<img src="rsrc_files/preview.png" width="500" height="534" alt="Preview" />
...
* **After:** Updated default layouts with clean, **resizable fixed-width monospace fonts** and customized assembly syntax coloring:
  ...
  * 💡 **Customization Note**: You can freely customize all editor syntax colors by editing the **`multiasm.ini`** configuration file to suit your preferences.
