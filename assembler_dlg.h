#ifndef _ASSEMBLER_DLG_V31_H_
#define _ASSEMBLER_DLG_V31_H_
...
// 1. Basic assembly commands (excluding JMP, CALL, RET, NOP)
#define HILITE_ASM_CMD_BASIC \
	"aaa aad aam aas adc add and cbw clc cld cli cmc cmp cmps cmpsb " \
	"cmpsw cwd daa das dec div esc idiv imul in inc int into lahf " \
	"lds lea les lods lodsb lodsw mov movs movsb movsw mul neg not or out " \
	"pop popf push pushf rcl rcr rol ror sahf sal sar sbb scas scasb scasw " \
	...
	"lar lsl sgdt sidt sldt smsw str verr verw clts lgdt lids lldt lmsw ltr " \
	"bsf bsr bt btc btr bts cdq cmpsd cwde insd lfs " \
	"lgs lodsd lss movsd movsx movzx " \
	...
	"cmovng cmovg cmovnle cmpxchg486 cmpxchg8b loadall loadall286 ibts " \
	"int01 int03 popaw popfw pushaw pushfw rdmsr rdpmc rdshr " \
...
// 2. Jump/Branch commands
#define HILITE_ASM_JMP_CMD \
	"ja jae jb jbe jc jcxz je jg jge jl jle jmp jna jnae jnb jnbe jnc jne " \
	"jng jnge jnl jnle jno jnp jns jnz jo jp jpe jpo js jz loop loope loopne " \
	"loopnz loopz jecxz loopd looped loopned loopnzd loopzd"

// 3. Call commands
#define HILITE_ASM_CALL_CMD \
	"call"

// 4. Return commands
#define HILITE_ASM_RET_CMD \
	"ret retf retn iret iretd iretdf iretf iretw"

// 5. Nop/Debugging/Traps
#define HILITE_ASM_NOP_CMD \
	"nop int3 int1 icebp hlt"
...
// 8. General Purpose & Simd/FPU/Debug Registers (excluding stack/special)
#define HILITE_REG_GP \
	"ah al ax bh bl bx ch cl cx dh di dl dx eax ebx ecx edi edx esi si " \
	"st st0 st1 st2 st3 st4 st5 st6 st7 mm0 mm1 mm2 mm3 mm4 mm5 mm6 mm7 " \
	"xmm0 xmm1 xmm2 xmm3 xmm4 xmm5 xmm6 xmm7 cr0 cr2 cr3 cr4 dr0 dr1 dr2 " \
	"dr3 dr6 dr7 tr3 tr4 tr5 tr6 tr7 " \
	"rax rbx rcx rdx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15 " \
	"r8d r9d r10d r11d r12d r13d r14d r15d r8w r9w r10w r11w r12w r13w r14w r15w " \
	"r8b r9b r10b r11b r12b r13b r14b r15b spl bpl sil dil"

// 9. Stack, Segment, and Instruction Pointer Registers (Special registers)
#define HILITE_REG_SPECIAL \
	"esp ebp eip rip sp bp ip cs ds es fs gs ss rsp rbp"
...
static void SetScintillaDesign(HWND hWnd, HINSTANCE hInst, RAFONT *praFont);
